...
<head>
		...
		<!--Script de php para iniciar la pagina con un usuario logeado-->
		<?php
		session_start();
		include 'serv.php';
	...
	<!-- Cabecera -->
			<header id="header" class="skel-layers-fixed">
				...
				<nav id="nav">
					...
					<li><a href="formulario.php" class="button special">Iniciar Sesión</a></li>
					<li><center><a href="evento.php" class="button special" data-hash="#Evento">Congreso</a></center></li>
					<li><center><a href="comentar.php" class="button special" data-hash="#Comentario">Dudas y comentarios</a></center></li>
			...
			<section id="banner">
				<div class="inner">
					...
					<ul class="actions">
						<li><a href="formulario.php" class="button big special">INICIAR SESION</a>
						<a href="registrousuario.php" class="button big alt">REGISTRARSE</a></li>
					</ul><br><br><br>
