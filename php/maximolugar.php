...
<body>
	...
	<!--EStas paginas pueden ser omitidas y hechas por popup-->
	<br><br><br><hr>
	<center><h2>Solo hay 50 Lugares disponibles</h2></center>
	<hr>
	...
	<script language="javascript">location.href = "registroeventousuario.php";</script>
</body>
</html>